...
class NoteManager extends Component {
    ...
    handleOnFindNotes(title) {
        ...
        NoteService.findNotesByTitle(title)
            .then(notes => {
                if (!notes) {
                    notes = [];
                }
    ...
    handleOnAddNote(note) {
        ...
        const { title, content, tags, priority } = note;
        ...
        console.log(title, content, tags, priority);
        NoteService.addNote(title, content, tags, priority)
            .then(newNote => {
                NoteService.listNotes()
                    .then(notes => {
